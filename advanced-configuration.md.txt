...
See also: [Including custom Java bundles](https://vespa-engine.github.io/pyvespa/application-packages.md#including-custom-java-bundles-and-other-extra-files) — ship custom Java components (searchers, document processors) via `ApplicationPackage(include_files=...)`.
