...
- [Ship custom Java bundles](https://vespa-engine.github.io/pyvespa/application-packages.md#including-custom-java-bundles-and-other-extra-files) (searchers, document processors, request handlers) via `ApplicationPackage(include_files=...)`.
