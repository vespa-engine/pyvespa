...
Every documentation page also has a Markdown version available by replacing `.html` with `.md.txt` in the URL. Look for the Markdown icon button (top-right of each page) to view it.
...
The snippet above works with [Claude Code](https://claude.ai/code) (`CLAUDE.md`), [GitHub Copilot](https://github.com/features/copilot) (`.github/copilot-instructions.md`), [Cursor](https://cursor.com) (`.cursor/rules/*.mdc`), [OpenAI Codex](https://openai.com/codex/) and most other AI coding tools that support [AGENTS.md](https://agents.md/). All of these read plain Markdown instructions.
