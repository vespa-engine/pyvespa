...
# NOTE: CustomHTTPAdapter tests commented out - CustomHTTPAdapter was removed and
# its functionality moved into VespaSync helper methods (_prepare_request_body, _request_with_retry)
# Compression and retry logic is still tested through integration tests
