...
# Reject overload, a client that did not keep the queue full, a CPU-bound
# runner, or an underloaded instance. In-flight (Little's law) is the direct
# client check; the CPU fraction is a backstop, since pyvespa's async paths
# reach ~85% of a 4-vCPU runner while still holding full in-flight.
